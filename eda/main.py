...
def stateGenJockeySpeedFigureAndDistanceFig(logger, race_url, data_dir, result_dir, race_smp_num, foal_smp_num):
...
def stateGenXXXFrameNumberAndRankAndDistanceFig(logger, race_url, data_dir, result_dir, race_smp_num, foal_smp_num):
    ...
    # 着順対枠対距離のグラフ描画（ジョッキー）
    genJockeyFrameNumberAndRankAndDistanceFig(result_dir, race_smp_num, jockey_name_list, jockey_race_data_list)
    ...
    # 着順対枠対距離のグラフ描画（調教師）
    genTamerFrameNumberAndRankAndDistanceFig(result_dir, race_smp_num, tamer_name_list, tamer_race_data_list)
    ...
    genBloodFrameNumberAndRankAndDistanceFig(result_dir, race_smp_num, horse_name_list, blood_race_data_list)




def stateCalcAnovaJockeyRankAndDistance(logger, race_url, data_dir, result_dir, race_smp_num, foal_smp_num):
    ...
    # ANOVA計算
    calcAnova(result_dir, race_smp_num, jockey_name_list, jockey_race_data_list)
...
if __name__ == "__main__":
    ...
    for race_url in race_url_list:
        ...
        #stateGenJockeySpeedFigureAndDistanceFig(logger, race_url, data_dir, result_dir, race_smp_num, foal_smp_num)

        #stateGenXXXFrameNumberAndRankAndDistanceFig(logger, race_url, data_dir, result_dir, race_smp_num, foal_smp_num)

        stateCalcAnovaJockeyRankAndDistance(logger, race_url, data_dir, result_dir, race_smp_num, foal_smp_num)
